...
<body>
	...
	<table border="1">
		...
		<c:forEach items="${tlist}" var="teacher">
			<tr>
				...
				<td>${teacher.tname}</td>
				<td>${teacher.taddress}</td>
				<td><a href="teacher/doadd">添加</a> <a href="teacher/dodel/${teacher.tid}">删除</a> <a href="teacher/doedit/${teacher.tid}">修改</a> <a
					href="javascript:void(0)" onclick="show1(${teacher.tid})">详细</a></td>
			</tr>
		</c:forEach>
	</table>
	<br />
	...
	<script type="text/javascript">
		function show1(tid){
		//  ${pageContext.request.contextPath}  ===> http://localhost:8087/JsonResponseTest
